...
HD_PWD='/home/nlvkhang/Documents/BK/Codes/hcmut/Verilog HDL/Vivado/Lab 2/Lab 2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2led7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin2led7.tcl
