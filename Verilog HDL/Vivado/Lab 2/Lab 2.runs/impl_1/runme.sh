...
HD_PWD='/home/nlvkhang/Documents/BK/Codes/hcmut/Verilog HDL/Vivado/Lab 2/Lab 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2led7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin2led7.tcl -notrace
